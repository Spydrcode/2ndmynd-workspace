/**
 * Pressure Translations by Industry Group
 *
 * Group-level defaults provide coverage for all industries.
 * Named industry overrides can refine these without duplicating the full table.
 */
...
export const GROUP_TRANSLATIONS: Record<
  IndustryGroup,
  Record<PressureKey, PressureTranslation>
> = {
  home_services_trade: {
    concentration_risk: {
    ...
    follow_up_drift: {
      ...
      boundary: "If you're booked 6+ weeks out on installs, follow-up pressure is seasonal and should be protected with deposits.",
    },
    capacity_pressure: {
      ...
      boundary: "If your work requires permits or inspections, lag is structural and should be built into expectations.",
    },
    decision_lag: {
      ...
      boundary: "If you're selling luxury or custom work, long cycles are expected and should be buffered with deposits.",
    },
    low_conversion: {
      ...
      recommended_move: "Review quote follow-up timing, simplify pricing tiers, and track close rates by quote size.",
      boundary: "If you're selling high-ticket or custom work, lower conversion is expected. Focus on pipeline depth.",
    },
    cashflow_drag: {
      ...
      recommended_move: "Invoice within 48 hours of completion and set a light collections rhythm for anything over 21 days unpaid.",
      boundary: "If your clients are commercial with NET30 terms, this drag is contractual and should be protected with progress billing.",
    },
    rhythm_volatility: {
      ...
      boundary: "If your work is seasonal (HVAC, roofing), volatility is structural and should be buffered with reserves.",
    },
    mapping_low_confidence: {
      ...
      recommended_move: "Confirm quote to invoice linkage and verify key date fields in your exports.",
  ...
  project_trades: {
    concentration_risk: {
      ...
      boundary: "If your model is custom high-end work, concentration is expected and should be protected with deposits.",
    },
    follow_up_drift: {
      ...
      recommended_move: "Define three quote tiers and set a 7-day decision window with one touch at day 3.",
      boundary: "If you're selling custom residential work, long cycles are expected and should be buffered with pipeline depth.",
    },
    capacity_pressure: {
      ...
      boundary: "If you're doing restoration or custom work, prep variability is structural and needs buffer time.",
    },
    decision_lag: {
      ...
      recommended_move: "Offer a small deposit to hold the date and simplify pricing into clear tiers.",
      boundary: "If you're selling luxury residential work, long decision cycles are expected and need pipeline depth.",
    },
    low_conversion: {
      ...
      recommended_move: "Simplify quotes into 3 tiers with visual examples and follow up at 48 hours with one clarifying question.",
      boundary: "If you're selling custom high-end work, lower conversion is expected. Focus on pipeline depth.",
    },
    cashflow_drag: {
      ...
      recommended_move: "Enforce milestone billing: 30% deposit, 30% at midpoint, 40% at completion.",
      boundary: "If your clients are commercial with NET30, this drag is contractual and should be front-loaded.",
    },
    rhythm_volatility: {
      ...
      recommended_move: "Batch projects by neighborhood or scope to stabilize weekly rhythm and reduce setup waste.",
      boundary: "If you're doing custom restoration, volatility is inherent and should be buffered with cash reserves.",
    },
    mapping_low_confidence: {
      ...
      recommended_move: "Verify job IDs link correctly across quotes and invoices and confirm milestone dates export properly.",
      boundary: "Do not act on specific numbers until mapping is verified. Use patterns directionally only.",
    },
  },
  route_service: {
    concentration_risk: {
      ...
      recommended_move: "Fill gaps with mid-sized recurring accounts to smooth revenue if one large account churns.",
      boundary: "If your model is commercial-heavy by design, concentration is expected and should be protected with contracts.",
    },
    follow_up_drift: {
      ...
      boundary: "If you're fully booked, follow-up pressure is capacity-driven and should be handled with pricing.",
    },
    capacity_pressure: {
      ...
      boundary: "If your territory is maxed, capacity pressure is geographic and needs a second route or higher minimums.",
    },
    decision_lag: {
      ...
      boundary: "If you're selling preventative maintenance, long cycles are expected and should be offset with trial offers.",
    },
    low_conversion: {
      ...
      recommended_move: "Offer trial service at a discount and follow up 24 hours later with recurring pricing options.",
      boundary: "If you're selling preventative work, lower conversion is expected and should be offset by trial velocity.",
    },
    cashflow_drag: {
      ...
      recommended_move: "Enforce autopay for recurring accounts and send invoices same-day after service completion.",
      boundary: "If your clients are commercial with NET15, this drag is contractual and should be protected with deposits.",
    },
    rhythm_volatility: {
      ...
      boundary: "If your service is seasonal, volatility is structural and should be buffered with off-season lanes.",
    },
    mapping_low_confidence: {
      owner_felt_line: "The numbers feel directionally right but not precise.",
  ...
  food_mobile: {
    concentration_risk: {
      ...
      recommended_move: "Build a secondary revenue stream (pre-orders, catering, packaged goods) to smooth daily volatility.",
      boundary: "If your model is event-based, concentration is expected and should be protected with deposits.",
    },
    follow_up_drift: {
      ...
      boundary: "If your model is mobile or pop-up, this pressure isn't relevant and should be ignored.",
    },
    capacity_pressure: {
      ...
      recommended_move: "Separate prep from service: prep in bulk off-peak and simplify the menu during rush.",
      boundary: "If your menu is complex or made-to-order, capacity pressure is structural and needs pre-orders.",
    },
    decision_lag: {
      ...
      boundary: "If your model is walk-up or event-based, this pressure isn't relevant. Focus on throughput.",
    },
    low_conversion: {
      ...
      recommended_move: "Simplify menu to 3-5 items max. Use combo pricing and add photos at the point of sale.",
      boundary: "If your model is specialty or made-to-order, lower conversion is expected. Focus on location and speed.",
    },
    cashflow_drag: {
      owner_felt_line: "Cash is immediate but daily expenses eat into it before deposits hit.",
      explanation: "When revenue is cash or card but expenses are same-day, cash buffer feels thin even on good days.",
      recommended_move: "Separate daily operating cash from owner pay and protect a 7-day expense buffer.",
      boundary: "If your model is event-heavy, cashflow drag is structural and needs deposits.",
    },
    rhythm_volatility: {
      ...
      recommended_move: "Track performance by location or event type and double down on proven slots.",
      boundary: "If your model is seasonal or event-based, volatility is inherent and needs cash reserves.",
    },
    mapping_low_confidence: {
      owner_felt_line: "The numbers feel directionally right but not precise.",
      explanation: "When POS data is cash-heavy or mixed, insights are directional but not decision-grade.",
      recommended_move: "Confirm POS exports include timestamps and location tags and separate cash from card sales.",
      boundary: "Do not act on specific numbers until mapping is verified. Use patterns directionally only.",
    },
  },
  sales_led: {
    concentration_risk: {
      ...
      recommended_move: "Build a mid-ticket offer that closes faster and fills gaps when large deals delay.",
      boundary: "If your model is enterprise sales, concentration is expected and should be protected with deposits.",
    },
    follow_up_drift: {
      ...
      boundary: "If you're selling complex B2B solutions, long cycles are expected and should be buffered with pipeline depth.",
    },
    capacity_pressure: {
      ...
      recommended_move: "Separate sales from delivery and protect a buffer between close and fulfillment expectations.",
      boundary: "If your product requires long lead times, capacity pressure is structural and needs upfront expectation setting.",
    },
    decision_lag: {
      ...
      recommended_move: "Qualify hard on budget and decision authority and walk away from deals without clear timelines.",
      boundary: "If you're selling enterprise or government contracts, long cycles are expected and need 3x pipeline coverage.",
    },
    low_conversion: {
      ...
      recommended_move: "Simplify proposals into tiers and qualify harder on budget authority upfront.",
      boundary: "If you're selling enterprise solutions, lower conversion is expected. Focus on pipeline coverage.",
    },
    cashflow_drag: {
      owner_felt_line: "Deals close but invoices sit unpaid for weeks, slowing growth.",
      explanation: "When clients are commercial with NET terms, cash timing lags revenue recognition. Growth feels constrained.",
      recommended_move: "Require a deposit on close and the remainder on delivery, with a discount for quick pay.",
      boundary: "If your clients are large commercial accounts, NET30-60 is contractual and needs cash buffers.",
    },
    rhythm_volatility: {
      ...
      recommended_move: "Add a fast-close offer that delivers predictable monthly revenue independent of large deals.",
      boundary: "If you're selling complex solutions, volatility is structural and needs recurring revenue lanes.",
    },
    mapping_low_confidence: {
      owner_felt_line: "The numbers feel directionally right but not precise.",
      explanation: "When CRM data doesn't sync with invoicing, insights are directional but not decision-grade.",
      recommended_move: "Confirm proposal to invoice linkage and verify close dates export correctly.",
      boundary: "Do not act on specific numbers until mapping is verified. Use patterns directionally only.",
    },
  },
  specialty_local: {
    concentration_risk: {
      ...
      boundary: "If your work is diagnostic-heavy, concentration is expected and should be protected with deposits.",
    },
    follow_up_drift: {
      ...
      recommended_move: "Call within 24 hours of diagnostic with approval options and set a 48-hour decision window.",
      boundary: "If repairs require parts ordering, follow-up lag is structural and needs upfront lead-time communication.",
    },
    capacity_pressure: {
      ...
      recommended_move: "Separate diagnostic slots from repair slots and batch parts ordering to reduce wait time.",
      boundary: "If your work requires specialty parts, capacity pressure is structural and needs expectation setting.",
    },
    decision_lag: {
      ...
      recommended_move: "Offer payment plans or tier pricing and set a 7-day estimate validity window.",
      boundary: "If your repairs are high-ticket or luxury, long cycles are expected and need diagnostic fees.",
    },
    low_conversion: {
      ...
      recommended_move: "Offer tiered repair options and call within 24 hours with financing options.",
      boundary: "If your repairs are high-ticket, lower conversion is expected and needs strong diagnostic framing.",
    },
    cashflow_drag: {
      ...
      recommended_move: "Require payment at pickup and use card-on-file for commercial accounts only.",
      boundary: "If your clients are commercial fleets, NET15 is common and needs deposits for large repairs.",
    },
    rhythm_volatility: {
      owner_felt_line: "Busy weeks feel chaotic, slow weeks feel dead. There's no steady rhythm.",
      explanation: "When demand is reactive, weekly volume swings wildly. Forecasting feels impossible.",
      recommended_move: "Build a recurring maintenance program to create baseline revenue independent of breakdowns.",
      boundary: "If your work is emergency-driven, volatility is inherent and should be buffered with reserves.",
    },
    mapping_low_confidence: {
      owner_felt_line: "The numbers feel directionally right but not precise.",
      explanation: "When work orders don't link to invoices cleanly, insights are directional but not decision-grade.",
      recommended_move: "Confirm estimate to invoice linkage and verify completion dates export correctly.",
      boundary: "Do not act on specific numbers until mapping is verified. Use patterns directionally only.",
    },
  },
};
